...
apt-get install -y --no-install-recommends \
  build-essential curl pkg-config libwayland-dev libxkbcommon-dev libdbus-1-dev
...
echo "SnowDesk prototype installed. Select 'SnowDesk' on your display manager."
